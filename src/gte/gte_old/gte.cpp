...
#define gteVX0     ((s16*)psxRegs.CP2D.p)[0]
#define gteVY0     ((s16*)psxRegs.CP2D.p)[1]
#define gteVZ0     ((s16*)psxRegs.CP2D.p)[2]
#define gteVX1     ((s16*)psxRegs.CP2D.p)[4]
#define gteVY1     ((s16*)psxRegs.CP2D.p)[5]
#define gteVZ1     ((s16*)psxRegs.CP2D.p)[6]
#define gteVX2     ((s16*)psxRegs.CP2D.p)[8]
#define gteVY2     ((s16*)psxRegs.CP2D.p)[9]
#define gteVZ2     ((s16*)psxRegs.CP2D.p)[10]
#define gteRGB     psxRegs.CP2D.r[6]
#define gteOTZ     ((s16*)psxRegs.CP2D.p)[7*2]
#define gteIR0     ((s32*)psxRegs.CP2D.p)[8]
#define gteIR1     ((s32*)psxRegs.CP2D.p)[9]
#define gteIR2     ((s32*)psxRegs.CP2D.p)[10]
#define gteIR3     ((s32*)psxRegs.CP2D.p)[11]
#define gteSXY0    ((s32*)psxRegs.CP2D.p)[12]
#define gteSXY1    ((s32*)psxRegs.CP2D.p)[13]
#define gteSXY2    ((s32*)psxRegs.CP2D.p)[14]
#define gteSXYP    ((s32*)psxRegs.CP2D.p)[15]
#define gteSX0     ((s16*)psxRegs.CP2D.p)[12*2]
#define gteSY0     ((s16*)psxRegs.CP2D.p)[12*2+1]
#define gteSX1     ((s16*)psxRegs.CP2D.p)[13*2]
#define gteSY1     ((s16*)psxRegs.CP2D.p)[13*2+1]
#define gteSX2     ((s16*)psxRegs.CP2D.p)[14*2]
#define gteSY2     ((s16*)psxRegs.CP2D.p)[14*2+1]
#define gteSXP     ((s16*)psxRegs.CP2D.p)[15*2]
#define gteSYP     ((s16*)psxRegs.CP2D.p)[15*2+1]
#define gteSZx     ((u16*)psxRegs.CP2D.p)[16*2]
#define gteSZ0     ((u16*)psxRegs.CP2D.p)[17*2]
#define gteSZ1     ((u16*)psxRegs.CP2D.p)[18*2]
#define gteSZ2     ((u16*)psxRegs.CP2D.p)[19*2]
...
#define gteMAC1    ((s32*)psxRegs.CP2D.p)[25]
#define gteMAC2    ((s32*)psxRegs.CP2D.p)[26]
#define gteMAC3    ((s32*)psxRegs.CP2D.p)[27]
...
#define gteR       ((u8 *)psxRegs.CP2D.p)[6*4]
#define gteG       ((u8 *)psxRegs.CP2D.p)[6*4+1]
#define gteB       ((u8 *)psxRegs.CP2D.p)[6*4+2]
#define gteCODE    ((u8 *)psxRegs.CP2D.p)[6*4+3]
#define gteC       gteCODE

#define gteR0      ((u8 *)psxRegs.CP2D.p)[20*4]
#define gteG0      ((u8 *)psxRegs.CP2D.p)[20*4+1]
#define gteB0      ((u8 *)psxRegs.CP2D.p)[20*4+2]
#define gteCODE0   ((u8 *)psxRegs.CP2D.p)[20*4+3]
#define gteC0      gteCODE0

#define gteR1      ((u8 *)psxRegs.CP2D.p)[21*4]
#define gteG1      ((u8 *)psxRegs.CP2D.p)[21*4+1]
#define gteB1      ((u8 *)psxRegs.CP2D.p)[21*4+2]
#define gteCODE1   ((u8 *)psxRegs.CP2D.p)[21*4+3]
#define gteC1      gteCODE1

#define gteR2      ((u8 *)psxRegs.CP2D.p)[22*4]
#define gteG2      ((u8 *)psxRegs.CP2D.p)[22*4+1]
#define gteB2      ((u8 *)psxRegs.CP2D.p)[22*4+2]
#define gteCODE2   ((u8 *)psxRegs.CP2D.p)[22*4+3]
#define gteC2      gteCODE2



#define gteR11  ((s16*)psxRegs.CP2C.p)[0]
#define gteR12  ((s16*)psxRegs.CP2C.p)[1]
#define gteR13  ((s16*)psxRegs.CP2C.p)[2]
#define gteR21  ((s16*)psxRegs.CP2C.p)[3]
#define gteR22  ((s16*)psxRegs.CP2C.p)[4]
#define gteR23  ((s16*)psxRegs.CP2C.p)[5]
#define gteR31  ((s16*)psxRegs.CP2C.p)[6]
#define gteR32  ((s16*)psxRegs.CP2C.p)[7]
#define gteR33  ((s16*)psxRegs.CP2C.p)[8]
#define gteTRX  ((s32*)psxRegs.CP2C.p)[5]
#define gteTRY  ((s32*)psxRegs.CP2C.p)[6]
#define gteTRZ  ((s32*)psxRegs.CP2C.p)[7]
#define gteL11  ((s16*)psxRegs.CP2C.p)[16]
#define gteL12  ((s16*)psxRegs.CP2C.p)[17]
#define gteL13  ((s16*)psxRegs.CP2C.p)[18]
#define gteL21  ((s16*)psxRegs.CP2C.p)[19]
#define gteL22  ((s16*)psxRegs.CP2C.p)[20]
#define gteL23  ((s16*)psxRegs.CP2C.p)[21]
#define gteL31  ((s16*)psxRegs.CP2C.p)[22]
#define gteL32  ((s16*)psxRegs.CP2C.p)[23]
#define gteL33  ((s16*)psxRegs.CP2C.p)[24]
#define gteRBK  ((s32*)psxRegs.CP2C.p)[13]
#define gteGBK  ((s32*)psxRegs.CP2C.p)[14]
#define gteBBK  ((s32*)psxRegs.CP2C.p)[15]
#define gteLR1  ((s16*)psxRegs.CP2C.p)[32]
#define gteLR2  ((s16*)psxRegs.CP2C.p)[33]
#define gteLR3  ((s16*)psxRegs.CP2C.p)[34]
#define gteLG1  ((s16*)psxRegs.CP2C.p)[35]
#define gteLG2  ((s16*)psxRegs.CP2C.p)[36]
#define gteLG3  ((s16*)psxRegs.CP2C.p)[37]
#define gteLB1  ((s16*)psxRegs.CP2C.p)[38]
#define gteLB2  ((s16*)psxRegs.CP2C.p)[39]
#define gteLB3  ((s16*)psxRegs.CP2C.p)[40]
#define gteRFC  ((s32*)psxRegs.CP2C.p)[21]
#define gteGFC  ((s32*)psxRegs.CP2C.p)[22]
#define gteBFC  ((s32*)psxRegs.CP2C.p)[23]
#define gteOFX  ((s32*)psxRegs.CP2C.p)[24]
#define gteOFY  ((s32*)psxRegs.CP2C.p)[25]
#define gteH    ((u16*)psxRegs.CP2C.p)[52]
#define gteDQA  ((s16*)psxRegs.CP2C.p)[54]
#define gteDQB  ((s32*)psxRegs.CP2C.p)[28]
#define gteZSF3 ((s16*)psxRegs.CP2C.p)[58]
#define gteZSF4 ((s16*)psxRegs.CP2C.p)[60]
