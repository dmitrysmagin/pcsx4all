...
{
  MIPS_EMIT(0, 0x24000000 | (rt << 16) | (imm16 & 0xffff)); /* li (aka addiu zero,) */
  return 1;
}

extern INLINE u32 gen(MOVU16, u32 rt, u32 imm16)
{
  MIPS_EMIT(0, 0x34000000 | (rt << 16) | (imm16 & 0xffff)); /* ori zero, */
  return 1;
}

extern INLINE u32 gen(MOVI32, u32 rt, u32 imm32)
{
  MIPS_EMIT(0, 0x3c000000 | (rt << 16) | (imm32 >> 16)); /* lui */
  MIPS_EMIT(0, 0x34000000 | (rt << 21) | (rt << 16) | (imm32 & 0xffff)); /* ori */
  return 2;
}
...
{
  MIPS_EMIT(0, 0x3c000000 | (rt << 16) | (imm16)); /* lui */
  return 0;
}

extern INLINE u32 gen(SLL, u32 rd, u32 rt, u32 sa) { MIPS_EMIT(0, (rt << 16) | (rd << 11) | ((sa & 31) << 6)); return 1; }
extern INLINE u32 gen(SRL, u32 rd, u32 rt, u32 sa) { MIPS_EMIT(0, 0x00000002 | (rt << 16) | (rd << 11) | ((sa & 31) << 6)); return 1; }
extern INLINE u32 gen(SRA, u32 rd, u32 rt, u32 sa) { MIPS_EMIT(0, 0x00000003 | (rt << 16) | (rd << 11) | ((sa & 31) << 6)); return 1; }
...
extern INLINE u32 gen(SLLV, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000004 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SLLV_RT0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000004 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SLLV_RS0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000004 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SLLV_RT0_RS0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000004 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRLV, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000006 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRLV_RT0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000006 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRLV_RS0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000006 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRLV_RT0_RS0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000006 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRAV, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000007 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRAV_RT0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000007 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRAV_RS0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000007 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(SRAV_RT0_RS0, u32 rd, u32 rt, u32 rs) { MIPS_EMIT(0, 0x00000007 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
...
extern INLINE u32 gen(NOR, u32 rd, u32 rs, u32 rt) { MIPS_EMIT(0, 0x00000027 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(NOR_RS0, u32 rd, u32 rs, u32 rt) { MIPS_EMIT(0, 0x00000027 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(NOR_RT0, u32 rd, u32 rs, u32 rt) { MIPS_EMIT(0, 0x00000027 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
extern INLINE u32 gen(NOR_RS0_RT0, u32 rd, u32 rs, u32 rt) { MIPS_EMIT(0, 0x00000027 | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }

extern INLINE u32 gen(SLT, u32 rd, u32 rs, u32 rt) { MIPS_EMIT(0, 0x0000002a | (rs << 21) | (rt << 16) | (rd << 11)); return 1; }
...
{
  MIPS_EMIT(0, 0x0000002b | (rs << 21) | (rt << 16) | (rd << 11)); /* sltu */
  return 1;
}
...
extern INLINE u32 gen(SLTI, u32 rt, u32 rs, s32 imm16) { MIPS_EMIT(0, 0x28000000 | (rs << 21) | (rt << 16) | (imm16 & 0xffff)); return 1; }
#define mips_gen_SLTI_RS0	mips_gen_SLTI

extern INLINE u32 gen(SLTIU, u32 rt, u32 rs, s32 imm16)
{
  MIPS_EMIT(0, 0x2c000000 | (rs << 21) | (rt << 16) | (imm16 & 0xffff));
  return 1;
}
...
{
  MIPS_EMIT(0, 0x30000000 | (rs << 21) | (rt << 16) | (imm16 & 0xffff));
  return 1;
}
...
{
  MIPS_EMIT(0, 0x34000000 | (rs << 21) | (rt << 16) | (imm16 & 0xffff));
  return 0;
}
